...
dism /image:c:\scratchdir /Remove-Package /PackageName:Microsoft-Windows-InternetExplorer-Optional-Package~31bf3856ad364e35~amd64~zh-TW~11.0.22621.1 > nul
...
dism /image:c:\scratchdir /Remove-Package /PackageName:Microsoft-Windows-LanguageFeatures-Handwriting-zh-TW-Package~31bf3856ad364e35~amd64~~10.0.22621.1265 > nul
echo Removing OCR:
dism /image:c:\scratchdir /Remove-Package /PackageName:Microsoft-Windows-LanguageFeatures-OCR-zh-TW-Package~31bf3856ad364e35~amd64~~10.0.22621.1265 > nul
echo Removing Speech:
dism /image:c:\scratchdir /Remove-Package /PackageName:Microsoft-Windows-LanguageFeatures-Speech-zh-TW-Package~31bf3856ad364e35~amd64~~10.0.22621.1265 > nul
echo Removing TTS:
dism /image:c:\scratchdir /Remove-Package /PackageName:Microsoft-Windows-LanguageFeatures-TextToSpeech-zh-TW-Package~31bf3856ad364e35~amd64~~10.0.22621.1265 > nul
